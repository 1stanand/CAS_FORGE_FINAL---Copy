...
Feature: CERSAI data addition for Property type collateral at Application Update Approval
...
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
  @Release3
  Scenario Outline: ACAUTOCAS-8960:  CERSAI page should see <FieldName> data for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum>
...
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
  @Release3
  Scenario Outline: ACAUTOCAS-8961:   CERSAI page should get <FieldName> data for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum> without property registration details
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_propertyDetails>" and row <Collateral_propertyDetails_rowNum>
    And user adds property type collateral based on "<CollateralSubType>" subtype
...
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
  @Release3
  Scenario Outline: ACAUTOCAS-8962:  CERSAI page should get <FieldName> data for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum> without current property registration details
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_propertyDetails>" and row <Collateral_propertyDetails_rowNum>
    And user adds property type collateral based on "<CollateralSubType>" subtype
...
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
  @Release3
  Scenario Outline: ACAUTOCAS-8963:  CERSAI page data validation for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_propertyDetails>" and row <Collateral_propertyDetails_rowNum>
...
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
  @Release3
Scenario Outline: ACAUTOCAS-16949:  CERSAI page modification validation <FieldName> data for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_propertyDetails>" and row <Collateral_propertyDetails_rowNum>
    And user adds property type collateral based on "<CollateralSubType>" subtype
...
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
  @Release3
Scenario Outline: ACAUTOCAS-16950: CERSAI page data reconciliation data for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_propertyDetails>" and row <Collateral_propertyDetails_rowNum>
    And user adds property type collateral based on "<CollateralSubType>" subtype
...
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
  @Release3
  Scenario Outline: ACAUTOCAS-8964:  CERSAI page security interest details validation data for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_propertyDetails>" and row <Collateral_propertyDetails_rowNum>
    And user adds property type collateral based on "<CollateralSubType>" subtype
...
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
  @Release3
  Scenario Outline: ACAUTOCAS-8965: CERSAI page security interest details data should not be deleted at collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_propertyDetails>" and row <Collateral_propertyDetails_rowNum>
    And user adds property type collateral based on "<CollateralSubType>" subtype
...
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
  @Release3
  Scenario Outline: ACAUTOCAS-8966: CERSAI page security interest details data should not be modified at collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_propertyDetails>" and row <Collateral_propertyDetails_rowNum>
    And user adds property type collateral based on "<CollateralSubType>" subtype
  ...
  @ImplementedBy-priyanshu.kashyap
    @Release3
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
Scenario Outline: ACAUTOCAS-16951: CERSAI page data validation for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_propertyDetails>" and row <Collateral_propertyDetails_rowNum>
    And user adds property type collateral based on "<CollateralSubType>" subtype
