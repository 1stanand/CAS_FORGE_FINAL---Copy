...
Feature: Construction On Land Insurance Addition
  ...
  Scenario Outline: ACAUTOCAS-2249: Insurance addition to a for <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline:ACAUTOCAS-2250:  Insurance details entity validation <Entity> for collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline:ACAUTOCAS-2251:Insurance details screen validation of <FieldName> for collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline: ACAUTOCAS-2252: CollateralPage Insurance details <Validity>  Policy Number with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
#FeatureID-ACAUTOCAS-227,ACAUTOCAS-5080

  Scenario Outline: ACAUTOCAS-17045: CollateralPage Insurance details <Validity> Cover Note Number with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
#FeatureID-ACAUTOCAS-227,ACAUTOCAS-5080
  ...
  Scenario Outline: ACAUTOCAS-17046: CollateralPage Insurance details <Validity> Cover Note Creation Date with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
#FeatureID-ACAUTOCAS-227,ACAUTOCAS-5080
  ...
  Scenario Outline: ACAUTOCAS-17047: CollateralPage Insurance details <Validity> Start Date with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
#FeatureID-ACAUTOCAS-227,ACAUTOCAS-5080
  ...
  Scenario Outline: ACAUTOCAS-17048: CollateralPage Insurance details <Validity> Maturity Date with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
#FeatureID-ACAUTOCAS-227,ACAUTOCAS-5080
  ...
  Scenario Outline: ACAUTOCAS-17049: CollateralPage Insurance details <Validity> Coverage Amount with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
#FeatureID-ACAUTOCAS-227,ACAUTOCAS-5080
  ...
  Scenario Outline: ACAUTOCAS-17050: CollateralPage Insurance details <Validity> Premium Amount with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
#FeatureID-ACAUTOCAS-227,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-17051: CollateralPage Insurance details <Validity> Loss Payee with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  @NotImplementable
  Scenario: ACAUTOCAS-2253:  CollateralPage insurance details format validation for collateral Sub Type Construction On Land
  ...
  Scenario Outline: ACAUTOCAS-2254: CollateralPage <InsuranceDetails> data type and labels for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline:ACAUTOCAS-2255: Insurance details nominee screen validation of <FieldName> for collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
#FeatureID-ACAUTOCAS-227,ACAUTOCAS-5080
  ...
  Scenario Outline: ACAUTOCAS-2256: CollateralPage Insurance details <Validity> Nominee Name with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline: ACAUTOCAS-17052: CollateralPage Insurance details <Validity> Date Of Birth Of Nominee with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
#FeatureID-ACAUTOCAS-227,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-17053:  CollateralPage Insurance details <Validity> Appointee Name with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
#FeatureID-ACAUTOCAS-227,ACAUTOCAS-5080
  ...
  Scenario Outline: ACAUTOCAS-17054: CollateralPage Insurance details <Validity> Appointee DOB with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
#FeatureID-ACAUTOCAS-227,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-17055: CollateralPage Insurance details <Validity> Percentage Of Entitlement with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  @SkippedFormatValidation
  @NotImplementable
  Scenario: ACAUTOCAS-2257:  CollateralPage nominee details format validation for collateral Sub Type Construction On Land
    When user opens an application at "DDE" stage from application grid
    And user opens "CollateralPage"
    And user modifies the collateral "Construction On Land"
    And user goes to insurance details section
    Then user should be able to see all fields of "<nominee details>" with proper format


  Scenario Outline: ACAUTOCAS-2258:  CollateralPage <NomineeDetails> data type and labels for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline: ACAUTOCAS-1346: Adding insurance details to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to fail with Reason
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline:ACAUTOCAS-1347: Adding insurance and nominee details to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage successfully
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline:ACAUTOCAS-2259: Adding additional insurance to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline: ACAUTOCAS-1348: Modifying <FieldName> field of insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline: ACAUTOCAS-2260: Deleting insurance already to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline:ACAUTOCAS-2261: Modifying insurance details attached to a collateral for <CollateralSubType> to add nominee details
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline:ACAUTOCAS-1349: Modifying insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add nominee
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline: ACAUTOCAS-1350:  Modifying insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add nominee with less than 100% entitlement
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline: ACAUTOCAS-2260: Modifying insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add multiple nominees
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline: ACAUTOCAS-1351:  Modifying insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add nominees with more than 100% entitlement
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline: ACAUTOCAS-1352:  Modifying insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add nominee and there address
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline: ACAUTOCAS-1353: Adding minor nominee without appointee in insurance details of collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to get message
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
# ${ProductType:["IPF"]}
  ...
  Scenario Outline: ACAUTOCAS-1354:  <CollateralSubType> data reconcile to validate if insurance and nominee data was saved properly
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
...
#FeatureID-ACAUTOCAS-227,ACAUTOCAS-5080,ACAUTOCAS-6414
  Scenario Outline: ACAUTOCAS-9018:  In <CollateralSubType> check pagination where more than 10 insurances are added
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 97
    And user fills mandatory fields of home page of collateral details for given collateral sub type
