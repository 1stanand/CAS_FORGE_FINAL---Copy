...
Feature: CERSAI data addition for Property type collateral at post approval
...
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
  Scenario Outline: ACAUTOCAS-8999: CERSAI page should see <FieldName> data for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum>
...
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
  Scenario Outline: ACAUTOCAS-9000:  CERSAI page should get <FieldName> data for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum> without property registration details
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_propertyDetails>" and row <Collateral_propertyDetails_rowNum>
    When user adds property type collateral based on "<CollateralSubType>" subtype
...
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
  Scenario Outline: ACAUTOCAS-9001:  CERSAI page should get <FieldName> data for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum> without current property registration details
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_propertyDetails>" and row <Collateral_propertyDetails_rowNum>
    When user adds property type collateral based on "<CollateralSubType>" subtype
...
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
  Scenario Outline: ACAUTOCAS-9002:  CERSAI page data validation for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_propertyDetails>" and row <Collateral_propertyDetails_rowNum>
...
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
Scenario Outline: ACAUTOCAS-16965: CERSAI page modification validation <FieldName> data for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_propertyDetails>" and row <Collateral_propertyDetails_rowNum>
    When user adds property type collateral based on "<CollateralSubType>" subtype
  ...
  @Perishable
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
Scenario Outline: ACAUTOCAS-16966: CERSAI page data reconciliation data for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum>
  ...
  @Perishable
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
  Scenario Outline: ACAUTOCAS-9003:  CERSAI page security interest details validation data for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_propertyDetails>" and row <Collateral_propertyDetails_rowNum>
    And user adds property type collateral based on "<CollateralSubType>" subtype
  ...
  @Perishable
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
  Scenario Outline: ACAUTOCAS-9004:  CERSAI page security interest details data should not be deleted at collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_propertyDetails>" and row <Collateral_propertyDetails_rowNum>
    And user adds property type collateral based on "<CollateralSubType>" subtype
  ...
  @ImplementedBy-priyanshu.kashyap
    ...
    @Perishable
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
  Scenario Outline: ACAUTOCAS-9005:  CERSAI page security interest details data should not be modified at collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_propertyDetails>" and row <Collateral_propertyDetails_rowNum>
    And user adds property type collateral based on "<CollateralSubType>" subtype
  ...
  @ImplementedBy-priyanshu.kashyap
    ...
    @Perishable
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
Scenario Outline: ACAUTOCAS-16967: CERSAI page data validation for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_propertyDetails_rowNum>
    ...
    Examples:
      ...
      | <ProductType> | <ApplicationStage> |     |          | indiv         | Builder Property Under Construction | Post Approval    | collateral.xlsx | property_details           | 0                                 | Modify |
      | <ProductType> | <ApplicationStage> |     |          | indiv         | Construction On Land                | Post Approval    | collateral.xlsx | property_details           | 12                                | Modify |
      | <ProductType> | <ApplicationStage> |     |          | indiv         | Plot + Self Construction            | Post Approval    | collateral.xlsx | property_details           | 24                                | Modify |
      | <ProductType> | <ApplicationStage> |     |          | indiv         | Ready Property                      | Post Approval    | collateral.xlsx | property_details           | 36                                | Modify |
      | <ProductType> | <ApplicationStage> |     |          | indiv         | Builder Property Under Construction | Post Approval    | collateral.xlsx | property_details           | 0                                 | Delete |
      | <ProductType> | <ApplicationStage> |     |          | indiv         | Construction On Land                | Post Approval    | collateral.xlsx | property_details           | 12                                | Delete |
      | <ProductType> | <ApplicationStage> |     |          | indiv         | Plot + Self Construction            | Post Approval    | collateral.xlsx | property_details           | 24                                | Delete |
      | <ProductType> | <ApplicationStage> |     |          | indiv         | Ready Property                      | Post Approval    | collateral.xlsx | property_details           | 36                                | Delete |
