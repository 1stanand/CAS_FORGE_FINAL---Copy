...
Feature: Kisan Vikas Patra Insurance Addition
  ...
  Scenario Outline: ACAUTOCAS-5222:  Insurance addition to <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-5223:  Insurance details <Entity> entity validation for collateral <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-5224:  Insurance details screen validation of <FieldName> field for collateral <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-5225: CollateralPage Insurance details <Validity>  Policy Number with <InputType> validation for collateral Sub Type <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-16842: CollateralPage Insurance details <Validity> Cover Note Number with <InputType> validation for collateral Sub Type <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-16843: CollateralPage Insurance details <Validity> Cover Note Creation Date with <InputType> validation for collateral Sub Type <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-16844: CollateralPage Insurance details <Validity> Start Date with <InputType> validation for collateral Sub Type <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-16845: CollateralPage Insurance details <Validity> Maturity Date with <InputType> validation for collateral Sub Type <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-16846: CollateralPage Insurance details <Validity> Coverage Amount with <InputType> validation for collateral Sub Type <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-16847: CollateralPage Insurance details <Validity> Premium Amount with <InputType> validation for collateral Sub Type <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-16848: CollateralPage Insurance details <Validity> Loss Payee with <InputType> validation for collateral Sub Type <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration"]}
    ...
    Examples:
      ...
      | valid    | Loss Payee | characters                                   | does not throw any error        | collateral.xlsx | insurance_details           | 111                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> |
      | valid    | Loss Payee | both digits and characters                   | does not throw any error        | collateral.xlsx | insurance_details           | 112                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> |
      | valid    | Loss Payee | negative                                     | does not throw any error        | collateral.xlsx | insurance_details           | 113                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> |
      | valid    | Loss Payee | space                                        | does not throw any error        | collateral.xlsx | insurance_details           | 114                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> |
      | valid    | Loss Payee | first character as special symbols           | does not throw any error        | collateral.xlsx | insurance_details           | 115                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> |
      | valid    | Loss Payee | last character as special symbols            | does not throw any error        | collateral.xlsx | insurance_details           | 116                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> |
      | valid    | Loss Payee | consecutive special characters               | does not throw any error        | collateral.xlsx | insurance_details           | 117                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> |
      | valid    | Loss Payee | non-consecutive special characters           | does not throw any error        | collateral.xlsx | insurance_details           | 118                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> |
...
#${Category:["SHARES","BONDS","METALS"]}
    ...
    Examples:
      ...
      | valid    | Loss Payee | characters                                   | does not throw any error        | collateral.xlsx | insurance_details           | 111                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> |
      | valid    | Loss Payee | both digits and characters                   | does not throw any error        | collateral.xlsx | insurance_details           | 112                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> |
      | valid    | Loss Payee | negative                                     | does not throw any error        | collateral.xlsx | insurance_details           | 113                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> |
      | valid    | Loss Payee | space                                        | does not throw any error        | collateral.xlsx | insurance_details           | 114                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> |
      | valid    | Loss Payee | first character as special symbols           | does not throw any error        | collateral.xlsx | insurance_details           | 115                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> |
      | valid    | Loss Payee | last character as special symbols            | does not throw any error        | collateral.xlsx | insurance_details           | 116                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> |
      | valid    | Loss Payee | consecutive special characters               | does not throw any error        | collateral.xlsx | insurance_details           | 117                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> |
      | valid    | Loss Payee | non-consecutive special characters           | does not throw any error        | collateral.xlsx | insurance_details           | 118                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> |
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-16849: CollateralPage Nominee details <Validity> Nominee Name with <InputType> validation for collateral Sub Type <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration"]}
    ...
    Examples:
      | Validity | FieldName    | InputType                  | Throws_NotThrows                | CollateralWB    | Collateral_insuranceDetails | Collateral_insuranceDetails_rowNum | ProductType   | ApplicationStage   | Key | Category | ApplicantType   | CollateralSubType   |
      | valid    | Nominee Name | positive digits            | does not throw any error        | collateral.xlsx | insurance_details           | 120                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> |
      | valid    | Nominee Name | characters                 | does not throw any error        | collateral.xlsx | insurance_details           | 121                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> |
...
#${Category:["SHARES","BONDS","METALS"]}
    ...
    Examples:
      | Validity | FieldName    | InputType                  | Throws_NotThrows                | CollateralWB    | Collateral_insuranceDetails | Collateral_insuranceDetails_rowNum | ProductType   | ApplicationStage   | Key | Category   | ApplicantType   | CollateralSubType   |
      | valid    | Nominee Name | positive digits            | does not throw any error        | collateral.xlsx | insurance_details           | 120                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> |
      | valid    | Nominee Name | characters                 | does not throw any error        | collateral.xlsx | insurance_details           | 121                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> |
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
    ...
    #FeatureID-ACAUTOCAS-236,ACAUTOCAS-5080
  @SkippedFormatValidation
  Scenario: ACAUTOCAS-5226:  CollateralPage insurance details format validation for collateral Sub Type <CollateralSubType>
    When user opens an application at "DDE" stage from application grid
    And user opens "CollateralPage"
    And user adds a new collateral type as "Deposit" and Sub Type "<CollateralSubType>"
    Then user should be able to see all fields of "<insurance details>" with proper format


  Scenario Outline: ACAUTOCAS-5227:  CollateralPage insurance details label of <InsuranceDetails> for collateral Sub Type <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-5228:  Insurance details nominee screen validation of <FieldName> for collateral <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-5229: CollateralPage Nominee details <Validity> Percentage Of Entitlement with <InputType> validation for collateral Sub Type <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-16850: CollateralPage Nominee details <Validity> Appointee DOB with <InputType> validation for collateral Sub Type <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-16851: CollateralPage Nominee details <Validity> Appointee Name with <InputType> validation for collateral Sub Type <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration"]}
    ...
    Examples:
      | Validity | FieldName      | InputType                  | Throws_NotThrows                | CollateralWB    | Collateral_insuranceDetails | Collateral_insuranceDetails_rowNum | ProductType   | ApplicationStage   | Key | Category | ApplicantType   | CollateralSubType   |
      | valid    | Appointee Name | characters                 | does not throw any error        | collateral.xlsx | insurance_details           | 134                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> |
      | valid    | Appointee Name | space                      | does not throw any error        | collateral.xlsx | insurance_details           | 135                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> |
...
#${Category:["SHARES","BONDS","METALS"]}
    ...
    Examples:
      | Validity | FieldName      | InputType                  | Throws_NotThrows                | CollateralWB    | Collateral_insuranceDetails | Collateral_insuranceDetails_rowNum | ProductType   | ApplicationStage   | Key | Category   | ApplicantType   | CollateralSubType   |
      | valid    | Appointee Name | characters                 | does not throw any error        | collateral.xlsx | insurance_details           | 134                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> |
      | valid    | Appointee Name | space                      | does not throw any error        | collateral.xlsx | insurance_details           | 135                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> |
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-16852: CollateralPage Nominee details <Validity> Date Of Birth Of Nominee with <InputType> validation for collateral Sub Type <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
    ...
    #FeatureID-ACAUTOCAS-236,ACAUTOCAS-5080
  @SkippedFormatValidation
  Scenario: ACAUTOCAS-5230:  CollateralPage nominee details format validation for collateral Sub Type <CollateralSubType>
    When user opens an application at "DDE" stage from application grid
    And user opens "CollateralPage"
    And user adds a new collateral type as "Deposit" and Sub Type "<CollateralSubType>"
  ...
  Scenario Outline: ACAUTOCAS-5231:  CollateralPage nominee details label of <NomineeDetails> field for collateral Sub Type <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#FeatureID-ACAUTOCAS-236,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-5118:  Adding insurance details to a collateral <CollateralSubType> to fail with <Collateral_insuranceDetails_rowNum> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-5119:  Adding insurance and nominee details to a collateral <CollateralSubType> successfully for <Collateral_insuranceDetails_rowNum> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration"]}
    ...
    Examples:
      ...
      | collateral.xlsx | insurance_details           | 263                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> |
...
#${Category:["SHARES","BONDS","METALS"]}
    ...
    Examples:
      ...
      | collateral.xlsx | insurance_details           | 263                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> |
...
#FeatureID-ACAUTOCAS-236,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-5232:  Adding additional insurance to a collateral <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#FeatureID-ACAUTOCAS-236,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-5233:  Modifying insurance details attached to a collateral <CollateralSubType> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#FeatureID-ACAUTOCAS-236,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-5234:  Deleting insurance already to a collateral of <ApplicantType> on <ProductType> on <ApplicationStage> of <CollateralSubType>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
    ...
    And user saves the collateral data
    And user opens Collateral Page
    When user click on modify the collateral sub type
    And user goes to insurance details section to fill insurance details
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_insuranceDetails>" and row <Collateral_insuranceDetails_rowNum>
    And user fills all insurance details of collateral subtype
    And user clicks on Done Button in Insurance
...
#FeatureID-ACAUTOCAS-236,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-5235:  Modifying insurance details attached to a collateral <CollateralSubType> to add nominee of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#FeatureID-ACAUTOCAS-236,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-5120:  Modifying insurance details attached to a collateral <CollateralSubType> to add nominee of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#FeatureID-ACAUTOCAS-236,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-5236:  Modifying insurance details attached to a collateral <CollateralSubType> to add nominee with less than 100% entitlement of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration"]}
    ...
    @Conventional
    Examples:
      | CollateralInsuranceWB | CollateralInsuranceWB_home | CollateralInsuranceWB_home_rowNum | ProductType   | ApplicationStage   | Key | Category | ApplicantType   | CollateralSubType   |
      | collateral.xlsx       | insurance_details          | 1                                 | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> |
...
#${Category:["SHARES","BONDS","METALS"]}
    ...
    Examples:
      | CollateralInsuranceWB | CollateralInsuranceWB_home | CollateralInsuranceWB_home_rowNum | ProductType   | ApplicationStage   | Key | Category   | ApplicantType   | CollateralSubType   |
      | collateral.xlsx       | insurance_details          | 1                                 | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> |
...
#FeatureID-ACAUTOCAS-236,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-5237:  Modifying insurance details attached to a collateral <CollateralSubType> to add multiple nominees of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-5238:  Modifying insurance details attached to a collateral <CollateralSubType> to add nominees with more than 100% entitlement of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#FeatureID-ACAUTOCAS-236,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-5121:  Modifying insurance details attached to a collateral <CollateralSubType> to add nominee and there address of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#FeatureID-ACAUTOCAS-236,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-5122:  Adding minor nominee without appointee in insurance details of collateral <CollateralSubType> to get message <description> of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#FeatureID-ACAUTOCAS-236,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-5123:  <CollateralSubType> data reconcile to validate if insurance and nominee data was saved properly of <ApplicantType> on <ProductType> on <ApplicationStage>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 253
    And user selects collateral type along with collateral sub type
...
#${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration"]}
    ...
    Examples:
      ...
      | collateral.xlsx | insurance_details           | 262                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> |
      | collateral.xlsx | insurance_details           | 263                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> |
      | collateral.xlsx | insurance_details           | 264                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> |
...
#${Category:["SHARES","BONDS","METALS"]}
    ...
    Examples:
      ...
      | collateral.xlsx | insurance_details           | 262                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> |
      | collateral.xlsx | insurance_details           | 263                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> |
      | collateral.xlsx | insurance_details           | 264                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> |
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  Scenario Outline: ACAUTOCAS-8921:  In "<CollateralSubType>" check pagination where more than 10 insurances are added
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "kisan_vikas_patra" and row 0
    And user selects collateral type along with collateral sub type
    And user fills mandatory fields of home page of collateral details for given collateral sub type
