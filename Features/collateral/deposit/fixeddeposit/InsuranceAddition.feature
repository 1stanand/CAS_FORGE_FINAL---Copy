...
Feature: Fixed Deposit Insurance Addition

  Background:
    Given user is on CAS Login Page
    And user logged in CAS with valid username and password present in "LoginDetailsCAS.xlsx" under "LoginData" and 0

  Scenario Outline: ACAUTOCAS-5205:  Insurance addition to Fixed Deposit
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
  ...
  Scenario Outline: ACAUTOCAS-5206:  Insurance details <Entity> entity validation for collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
  ...
  Scenario Outline: ACAUTOCAS-5207:  Insurance details screen validation of <FieldName> field for collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
  ...
  Scenario Outline: ACAUTOCAS-5208:  CollateralPage Insurance details <Validity>  Policy Number with <InputType> validation for collateral sub type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
...
#FeatureID-ACAUTOCAS-235,ACAUTOCAS-5080
Scenario Outline: ACAUTOCAS-16937: CollateralPage Insurance details <Validity> Cover Note Number with <InputType> validation for collateral sub type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
...
#FeatureID-ACAUTOCAS-235,ACAUTOCAS-5080
Scenario Outline: ACAUTOCAS-16938: CollateralPage Insurance details <Validity> Cover Note Creation Date with <InputType> validation for collateral sub type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
...
#FeatureID-ACAUTOCAS-235,ACAUTOCAS-5080
Scenario Outline: ACAUTOCAS-16939: CollateralPage Insurance details <Validity> Start Date with <InputType> validation for collateral sub type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
...
#FeatureID-ACAUTOCAS-235,ACAUTOCAS-5080
Scenario Outline: ACAUTOCAS-16940: CollateralPage Insurance details <Validity> Maturity Date with <InputType> validation for collateral sub type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
...
#FeatureID-ACAUTOCAS-235,ACAUTOCAS-5080
Scenario Outline: ACAUTOCAS-16941: CollateralPage Insurance details <Validity> Coverage Amount with <InputType> validation for collateral sub type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
...
#FeatureID-ACAUTOCAS-235,ACAUTOCAS-5080
Scenario Outline: ACAUTOCAS-16942: CollateralPage Insurance details <Validity> Premium Amount with <InputType> validation for collateral sub type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
...
#FeatureID-ACAUTOCAS-235,ACAUTOCAS-5080
Scenario Outline: ACAUTOCAS-16943: CollateralPage Insurance details <Validity> Loss Payee with <InputType> validation for collateral sub type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
  ...
  #FeatureID-ACAUTOCAS-235,ACAUTOCAS-5080
  Scenario: ACAUTOCAS-5209:  CollateralPage insurance details format validation for collateral sub type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
  ...
  Scenario Outline: ACAUTOCAS-5210:  CollateralPage insurance details label of <InsuranceDetails> for collateral sub type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
  ...
  Scenario Outline: ACAUTOCAS-5211:  CollateralPage insurance details label of <FieldName> for collateral sub type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage <FieldName>
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
  ...
  Scenario Outline: ACAUTOCAS-5212: CollateralPage Insurance details <Validity> Nominee Name with <InputType> validation for collateral sub type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
...
# ${ProductType:["IAF","IHF"]}
  ...
  #FeatureID-ACAUTOCAS-235,ACAUTOCAS-5080
Scenario Outline: ACAUTOCAS-16944: CollateralPage Insurance details <Validity> Date Of Birth Of Nominee with <InputType> validation for collateral sub type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
...
#FeatureID-ACAUTOCAS-235,ACAUTOCAS-5080
Scenario Outline: ACAUTOCAS-16945: CollateralPage Nominee details <Validity> Appointee Name with <InputType> validation for collateral Sub Type Commercial Equipment
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
...
#FeatureID-ACAUTOCAS-235,ACAUTOCAS-5080
Scenario Outline: ACAUTOCAS-16946: CollateralPage Nominee details <Validity> Appointee DOB with <InputType> validation for collateral Sub Type Commercial Equipment
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
...
Scenario Outline: ACAUTOCAS-16947: CollateralPage Insurance details <Validity> Percentage Of Entitlement with <InputType> validation for collateral sub type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
  ...
  @NotImplementable
  #FeatureID-ACAUTOCAS-235,ACAUTOCAS-5080
  Scenario: ACAUTOCAS-5213:  CollateralPage nominee details format validation for collateral sub type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    When user opens an application at "DDE" stage from application grid
    And user opens "CollateralPage"
    And user adds a new collateral type as "Deposit" and Sub Type "Fixed Deposit"
    Then user should be able to see all fields of "<nominee details>" with proper format

  Scenario Outline: ACAUTOCAS-5214:  CollateralPage <NomineeDetails> data type and labels for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
  ...
  Scenario Outline: ACAUTOCAS-5112: Adding insurance details to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to fail with Reason
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
  ...
  Scenario Outline: ACAUTOCAS-5113:  Adding insurance and nominee details to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage successfully
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
    ...
    Examples:
      | CollateralWB    | Collateral_insuranceDetails | Collateral_insuranceDetails_rowNum | ProductType   | ApplicationStage   | Key | Category | ApplicantType   | CollateralSubType   | Collateral_defaultSheet | Collateral_defaultSheet_rowNum | Collateral_FdSheet | Collateral_dFdSheet_rowNum |
      | collateral.xlsx | insurance_details           | 263                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 264                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 265                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 266                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 267                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 268                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 269                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 270                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
    ...
    Examples:
      | CollateralWB    | Collateral_insuranceDetails | Collateral_insuranceDetails_rowNum | ProductType   | ApplicationStage   | Key | Category   | ApplicantType   | CollateralSubType   | Collateral_defaultSheet | Collateral_defaultSheet_rowNum | Collateral_FdSheet | Collateral_dFdSheet_rowNum |
      | collateral.xlsx | insurance_details           | 263                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 264                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 265                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 266                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 267                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 268                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 269                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 270                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
  ...
  Scenario Outline: ACAUTOCAS-5215:  Adding additional insurance to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
  ...
  @ImplementedBy-aditya.tomar
    Scenario Outline: ACAUTOCAS-5216:  Modifying insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add nominee "<FieldName>"
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
  ...
  @ImplementedBy-aditya.tomar
    Scenario Outline: ACAUTOCAS-5217:  Deleting insurance already to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
  ...
  @ImplementedBy-aditya.tomar
    Scenario Outline: ACAUTOCAS-5218:  Modifying insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add nominee
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
  ...
  @ImplementedBy-ankit.yadav
    Scenario Outline: ACAUTOCAS-5114:  Modifying insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add nominee
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
    ...
    Examples:
      | CollateralWB    | Collateral_insuranceDetails | Collateral_insuranceDetails_rowNum | ProductType   | ApplicationStage   | Key | Category | ApplicantType   | CollateralSubType   | Collateral_defaultSheet | Collateral_defaultSheet_rowNum | Collateral_FdSheet | Collateral_dFdSheet_rowNum |
      | collateral.xlsx | insurance_details           | 245                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
    ...
    Examples:
      | CollateralWB    | Collateral_insuranceDetails | Collateral_insuranceDetails_rowNum | ProductType   | ApplicationStage   | Key | Category   | ApplicantType   | CollateralSubType   | Collateral_defaultSheet | Collateral_defaultSheet_rowNum | Collateral_FdSheet | Collateral_dFdSheet_rowNum |
      | collateral.xlsx | insurance_details           | 245                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
  ...
  @ImplementedBy-aditya.tomar
    Scenario Outline: ACAUTOCAS-5219:  Modifying insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add nominee with less than 100% entitlement
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
  ...
  Scenario Outline: ACAUTOCAS-5220:  Modifying insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add multiple nominees
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
  ...
  @ImplementedBy-ankit.yadav
    Scenario Outline: ACAUTOCAS-5221:  Modifying insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add nominees with more than 100% entitlement
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
  ...
  @ImplementedBy-ankit.yadav
    Scenario Outline: ACAUTOCAS-5115:  Modifying insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add nominee and there address
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
  ...
  @ImplementedBy-ankit.yadav
    Scenario Outline: ACAUTOCAS-5116:  Adding minor nominee <description> in insurance details of collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to get message
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
  ...
  @ImplementedBy-ankit.yadav
    Scenario Outline: ACAUTOCAS-5117:  <CollateralSubType> data reconcile to validate if insurance and nominee data was saved properly
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
    ...
    Examples:
      | CollateralWB    | Collateral_insuranceDetails | Collateral_insuranceDetails_rowNum | ProductType   | ApplicationStage   | Key | Category | ApplicantType   | CollateralSubType   | Collateral_defaultSheet | Collateral_defaultSheet_rowNum | Collateral_FdSheet | Collateral_dFdSheet_rowNum |
      | collateral.xlsx | insurance_details           | 256                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 234                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 235                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 236                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 237                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 238                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 239                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 240                                | <ProductType> | <ApplicationStage> |     |          | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
    ...
    Examples:
      | CollateralWB    | Collateral_insuranceDetails | Collateral_insuranceDetails_rowNum | ProductType   | ApplicationStage   | Key | Category   | ApplicantType   | CollateralSubType   | Collateral_defaultSheet | Collateral_defaultSheet_rowNum | Collateral_FdSheet | Collateral_dFdSheet_rowNum |
      | collateral.xlsx | insurance_details           | 256                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 234                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 235                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 236                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 237                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 238                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 239                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
      | collateral.xlsx | insurance_details           | 240                                | <ProductType> | <ApplicationStage> |     | <Category> | <ApplicantType> | <CollateralSubType> | default                 | 16                             | fixed_deposit      | 0                          |
...
#FeatureID-ACAUTOCAS-235,ACAUTOCAS-5080,ACAUTOCAS-6414
  @ImplementedBy-ankit.yadav
    Scenario Outline: ACAUTOCAS-8920:  In <CollateralSubType> check pagination where more than 10 insurances are added to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_defaultSheet>" and row <Collateral_defaultSheet_rowNum>
    And user selects collateral type along with collateral sub type
