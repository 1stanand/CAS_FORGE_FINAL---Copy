...
Feature: Internal Collateral Consumer Durable Search
...
#Internal Collateral Search
  Scenario Outline: ACAUTOCAS-3120: Provision to search internal collateral Consumer Durable of <applicantType> on <ProductType> on <ApplicationStage> at <Collateral_collateralSearch_rowNum>
    Given user is on CAS Login Page
    And user logged in CAS with valid username and password present in "LoginDetailsCAS.xlsx" under "LoginData" and 0
