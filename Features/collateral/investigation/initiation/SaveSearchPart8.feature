...
Feature: Collateral investigation initiation screen validation for save search part 8

  Scenario Outline: ACAUTOCAS-4425: user saves search criteria <Cii_ciiGrid_rowNum> for CII with various search parameters part 8
