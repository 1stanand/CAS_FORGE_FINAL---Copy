...
Feature: Collateral investigation initiation screen validation for save search part 3

  Scenario Outline: ACAUTOCAS-4420: user saves search criteria <Cii_ciiGrid_rowNum> for CII with various search parameters part 3
