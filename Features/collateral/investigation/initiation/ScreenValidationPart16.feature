...
@LoggedBug
Feature: Collateral investigation initiation screen validation for search application part 16

  #After discussion with Author, Last Updated Date field is now being validated in a separate scenario
  Scenario Outline:ACAUTOCAS-4434:user searches the application for CII with search parameters present in <Cii_ciiGrid_rowNum> part 16
    ...
    Examples:
      ...
      | collateral_investigation_initiation.xlsx | cii_grid    | 913                | api     | 0              |
