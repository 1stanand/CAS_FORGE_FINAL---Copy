...
Feature: Collateral investigation initiation screen validation for save search part 1

  Scenario Outline: ACAUTOCAS-4408: user saves search criteria <Cii_ciiGrid_rowNum> for CII with various search parameters part 1
