...
Feature: Collateral investigation initiation screen validation for save search part 2

  Scenario Outline: ACAUTOCAS-4419: user saves search criteria <Cii_ciiGrid_rowNum> for CII with various search parameters part 2
