...
Feature: Collateral investigation initiation screen validation for save search part 10

  Scenario Outline: ACAUTOCAS-4409: user saves search criteria <Cii_ciiGrid_rowNum> for CII with various search parameters part 10
