...
Feature: Collateral investigation initiation screen validation for load search part 6

#FeatureID-ACAUTOCAS-363
  Scenario Outline: ACAUTOCAS-4404: user loads search criteria <Cii_ciiGrid_rowNum> for CII with various search parameters part 6
