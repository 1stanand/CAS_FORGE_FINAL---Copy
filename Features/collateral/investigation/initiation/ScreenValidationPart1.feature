...
@LoggedBug
Feature: Collateral investigation initiation screen validation for search application part 1

  #After discussion with Author, Last Updated Date field is now being validated in a separate scenario
  Scenario Outline: ACAUTOCAS-3147: user searches the application for CII with search parameters present in <Cii_ciiGrid_rowNum> part 1
