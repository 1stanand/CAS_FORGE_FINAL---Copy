...
Feature: Collateral investigation initiation screen validation for save search part 18

#FeatureID-ACAUTOCAS-363
  Scenario Outline: ACAUTOCAS-4417: user saves search criteria <Cii_ciiGrid_rowNum> for CII with various search parameters
