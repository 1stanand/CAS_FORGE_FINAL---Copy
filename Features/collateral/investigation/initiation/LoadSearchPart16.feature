...
Feature: Collateral investigation initiation screen validation for load search part 16


  Scenario Outline: ACAUTOCAS-4396: user loads search criteria <Cii_ciiGrid_rowNum> for CII with various search parameters part 16
