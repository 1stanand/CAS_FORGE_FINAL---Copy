...
Feature: Collateral investigation initiation screen validation for load search part 5


#FeatureID-ACAUTOCAS-363
  Scenario Outline: ACAUTOCAS-4403: user loads search criteria <Cii_ciiGrid_rowNum> for CII with various search parameters part 5
