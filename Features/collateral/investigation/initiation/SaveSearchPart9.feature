...
Feature: Collateral investigation initiation screen validation for save search part 9

  Scenario Outline: ACAUTOCAS-4426: user saves search criteria <Cii_ciiGrid_rowNum> for CII with various search parameters part 9
