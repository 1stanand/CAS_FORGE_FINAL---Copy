...
Feature: Collateral investigation initiation screen validation for load search part 17


  Scenario Outline: ACAUTOCAS-4397: user loads search criteria <Cii_ciiGrid_rowNum> for CII with various search parameters part 17
