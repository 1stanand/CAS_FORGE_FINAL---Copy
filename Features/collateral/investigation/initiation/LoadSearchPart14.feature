...
Feature: Collateral investigation initiation screen validation for load search part 14


  Scenario Outline: ACAUTOCAS-4394: user loads search criteria <Cii_ciiGrid_rowNum> for CII with various search parameters part 14
