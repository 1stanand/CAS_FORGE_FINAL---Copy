...
Feature: Collateral investigation initiation screen validation for save search part 4

  Scenario Outline: ACAUTOCAS-4421: user saves search criteria <Cii_ciiGrid_rowNum> for CII with various search parameters part 4
