...
Feature: Internal Collateral Fixed Deposit Search
...
#Internal Collateral Search
  Scenario Outline:  ACAUTOCAS-3128:Provision to search internal collateral of fixed deposit of <applicantType> on <ProductType> on <ApplicationStage> at <Collateral_collateralSearch_rowNum>
    Given user is on CAS Login Page
    And user logged in CAS with valid username and password present in "LoginDetailsCAS.xlsx" under "LoginData" and 0
