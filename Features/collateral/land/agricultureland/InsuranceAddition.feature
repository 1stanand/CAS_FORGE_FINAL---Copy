...
Feature: Agriculture Land Insurance Addition
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-2211:  Insurance addition to a <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-2212:  Insurance details entity validation for collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-2213:  Insurance details screen validation for collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-2214: CollateralInsurance Page <Validity> Policy Number Name with <InputType> validation for collateral Land and Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
Scenario Outline: ACAUTOCAS-17034: CollateralPage Insurance details <Validity> Cover Note Number with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080 
Scenario Outline: ACAUTOCAS-17035: CollateralPage Insurance details <Validity> Cover Note Creation Date with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080 
Scenario Outline: ACAUTOCAS-17036: CollateralPage Insurance details <Validity> Start Date with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080 
Scenario Outline: ACAUTOCAS-17037: CollateralPage Insurance details <Validity> Maturity Date with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080 
Scenario Outline: ACAUTOCAS-17038: CollateralPage Insurance details <Validity> Coverage Amount with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080 
Scenario Outline: ACAUTOCAS-17039: CollateralPage Insurance details <Validity> Premium Amount with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
Scenario Outline: ACAUTOCAS-17040: CollateralInsurance Page <Validity> Loss Payee with <InputType> validation for collateral Land and Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  Scenario: ACAUTOCAS-2215:  CollateralPage insurance details format validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    When user opens an application at "DDE" stage from application grid
    And user opens "CollateralPage"
    And user modifies the collateral "Agriculture Land"
    And user goes to insurance details section
    Then user should be able to see all fields of "<insurance details>" with proper format

  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-2216:  CollateralPage insurance details data type and labels for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-2217:  Insurance details nominee screen validation for collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080 
  Scenario Outline: ACAUTOCAS-2218: CollateralPage Insurance details <Validity> Nominee Name with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080 
Scenario Outline: ACAUTOCAS-17041: CollateralPage Insurance details <Validity> Date Of Birth Of Nominee with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080 
Scenario Outline: ACAUTOCAS-17042: CollateralPage Insurance details <Validity> Appointee Name with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080 
Scenario Outline: ACAUTOCAS-17043: CollateralPage Insurance details <Validity> Appointee DOB with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080 
Scenario Outline: ACAUTOCAS-17044: CollateralPage Insurance details <Validity> Percentage Of Entitlement with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @SkippedFormatValidation
  Scenario: ACAUTOCAS-2219:  CollateralPage nominee details format validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    When user opens an application at "DDE" stage from application grid
    And user opens "CollateralPage"
    And user modifies the collateral "Agriculture Land"
    And user goes to insurance details section
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-2220:  CollateralPage nominee details data type and labels for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-3165:  Adding insurance details to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to fail with fail message due to <Collateral_insuranceDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline:ACAUTOCAS-3166:  Adding insurance and nominee details to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage successfully for <Collateral_insuranceDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-2221:  Adding additional insurance to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-3167: Modifying <FieldName> insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-2222:  Deleting insurance already to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-3168:  Modifying insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add nominee
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline:ACAUTOCAS-2223: Modifying insurance details attached to a collateral agriculture land to add nominee
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline:  ACAUTOCAS-3169: Modifying insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add nominee with less than 100 percent entitlement
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-2224:  Modifying insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add multiple nominees
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline:ACAUTOCAS-3170:  Modifying insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add nominees with more than 100% entitlement
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline:ACAUTOCAS-3171:  Modifying insurance details attached to a collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add nominee and there address
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline:ACAUTOCAS-3172: Adding minor nominee without appointee in insurance details of collateral <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to get error message <description>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080
  Scenario Outline: ACAUTOCAS-3173: <CollateralSubType> to <ProductType> application at <ApplicationStage> stage data reconcile to validate if insurance and nominee data was saved properly
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
  ...
  @Release3  
#FeatureID-ACAUTOCAS-239,ACAUTOCAS-5080,ACAUTOCAS-6414
  Scenario Outline: ACAUTOCAS-8929:  In <CollateralSubType> to <ProductType> application at <ApplicationStage> stage check pagination where more than 10 insurances are added
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<ApplicationStage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "default" and row 6
    And user selects collateral type along with collateral sub type
