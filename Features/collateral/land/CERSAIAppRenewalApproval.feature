...
Feature: CERSAI data addition for Land type collateral at Application Renewal Approval
...
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-239
  Scenario Outline: ACAUTOCAS-8930:  CERSAI page data validation for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_agricultureDetails_rowNum>
  ...
  @Release
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-239
  Scenario Outline: ACAUTOCAS-8931: CERSAI page modification validation <FieldName> data for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_agricultureDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_agricultureDetails>" and row <Collateral_agricultureDetails_rowNum>
  ...
  @Release
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-239
  Scenario Outline: ACAUTOCAS-8932:   CERSAI page data reconciliation data for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_agricultureDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_agricultureDetails>" and row <Collateral_agricultureDetails_rowNum>
    And user adds land type collateral based on "<CollateralSubType>" subtype
  ...
  @Release
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-239
  Scenario Outline: ACAUTOCAS-8933:  CERSAI page security interest details validation data for collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_agricultureDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_agricultureDetails>" and row <Collateral_agricultureDetails_rowNum>
    And user adds land type collateral based on "<CollateralSubType>" subtype
  ...
  @Release
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-239
  Scenario Outline: ACAUTOCAS-8934: CERSAI page security interest details data should not be deleted at collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_agricultureDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_agricultureDetails>" and row <Collateral_agricultureDetails_rowNum>
    And user adds land type collateral based on "<CollateralSubType>" subtype
...
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-225,ACAUTOCAS-226,ACAUTOCAS-227,ACAUTOCAS-228,ACAUTOCAS-229
  Scenario Outline: ACAUTOCAS-8935: CERSAI page security interest details data should not be modified at collateral Property for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_agricultureDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_agricultureDetails>" and row <Collateral_agricultureDetails_rowNum>
    And user adds land type collateral based on "<CollateralSubType>" subtype
  ...
  @NotImplemented
#FeatureID-ACAUTOCAS-5077,ACAUTOCAS-239
Scenario Outline: ACAUTOCAS-16918:  CERSAI page data validation for collateral Land for <CollateralSubType> of <ProductType> at <ApplicationStage> stage with <Collateral_agricultureDetails_rowNum>
    And user opens an "<ProductType>" application for "<applicantType>" applicant at "<Var_Stage>" for "<category>" with "<key>" from application grid
    And user opens Collateral Page for adding new collateral for "<Var_Stage>"
    And user reads data from the excel file "<CollateralWB>" under sheet "<Collateral_agricultureDetails>" and row <Collateral_agricultureDetails_rowNum>
    And user adds collateral based on "<CollateralSubType>" subtype
