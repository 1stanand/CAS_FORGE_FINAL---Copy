...
Feature: Commercial Equipment Insurance Addition
...
#  In this feature we will attach Insurance to the Collateral
  ...
  Scenario Outline: ACAUTOCAS-2045: Insurance addition to a collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    ...
    And user fills mandatory fields of asset details of collateral sub type
...
##Collateral Insurance Validations
  Scenario Outline: ACAUTOCAS-2478: Insurance details entity validation of <Entity> for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
# ${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration","Disbursal"]}
  ...
  Scenario Outline: ACAUTOCAS-2479: Insurance details screen validation of <FieldName> for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
# ${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration","Disbursal"]}
  ...
  Scenario Outline: ACAUTOCAS-2048: CollateralPage Insurance details <Validity>  Policy Number with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
# ${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration","Disbursal"]}
  ...
  Scenario Outline: ACAUTOCAS-16633: CollateralPage Insurance details <Validity> Cover Note Number with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
# ${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration","Disbursal"]}
  ...
  Scenario Outline: ACAUTOCAS-16634: CollateralPage Insurance details <Validity> Cover Note Creation Date with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
# ${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration","Disbursal"]}
  ...
  Scenario Outline: ACAUTOCAS-16635: CollateralPage Insurance details <Validity> Start Date with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
# ${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration","Disbursal"]}
  ...
  Scenario Outline: ACAUTOCAS-16636: CollateralPage Insurance details <Validity> Maturity Date with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
# ${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration","Disbursal"]}
  ...
  Scenario Outline: ACAUTOCAS-16637: CollateralPage Insurance details <Validity> Coverage Amount with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
# ${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration","Disbursal"]}
  ...
  Scenario Outline: ACAUTOCAS-16638: CollateralPage Insurance details <Validity> Premium Amount with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
# ${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration","Disbursal"]}
  ...
  Scenario Outline: ACAUTOCAS-16639: CollateralPage Insurance details <Validity> Loss Payee with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
# ${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration","Disbursal"]}
  ...
  @NotImplementable
  Scenario: ACAUTOCAS-2049:  CollateralPage insurance details format validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
  ...
  @Release
  Scenario Outline: ACAUTOCAS-2050: CollateralPage insurance details label of <InsuranceDetails> for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
# ${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration","Disbursal"]}
  ...
  @Release
  Scenario Outline: ACAUTOCAS-2480: Insurance details nominee screen validation of <FieldName> for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
# ${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration","Disbursal"]}
  ...
  @Release
  Scenario Outline: ACAUTOCAS-2052: CollateralPage Nominee details <Validity> Nominee Name with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
# ${ApplicationStage:["DDE","Credit Approval","Recommendation","Reconsideration","Disbursal"]}
  ...
  @Release
  Scenario Outline: ACAUTOCAS-16640: CollateralPage Nominee details <Validity> Date Of Birth Of Nominee with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  @Release
  Scenario Outline: ACAUTOCAS-16641: CollateralPage Nominee details <Validity> Appointee Name with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  @Release
  Scenario Outline: ACAUTOCAS-16642: CollateralPage Nominee details <Validity> Appointee DOB with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  @Release
  Scenario Outline: ACAUTOCAS-16643: CollateralPage Nominee details <Validity> Percentage Of Entitlement with <InputType> validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  @SkippedFormatValidation
  Scenario: ACAUTOCAS-2053:  CollateralPage nominee details format validation for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    When user opens an application at "DDE" stage from application grid
    And user opens "CollateralPage"
    And user modifies the collateral "<CollateralSubType>"
    And user goes to insurance details section
  ...
  @Release
  Scenario Outline: ACAUTOCAS-2054: CollateralPage nominee details label of <NomineeDetails> field for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  @Release
  Scenario Outline: ACAUTOCAS-2840: Adding insurance details to for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to fail
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  @Release
  Scenario Outline: ACAUTOCAS-1019: Adding insurance and nominee details to for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage successfully
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  @Release
  Scenario Outline: ACAUTOCAS-2055: Adding additional insurance to for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage with all mandatory fields
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  @Release
  Scenario Outline: ACAUTOCAS-1020: Modifying insurance details <FieldName> attached to for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  @Release
  Scenario Outline: ACAUTOCAS-2056: Deleting insurance already to for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  @Release
  Scenario Outline: ACAUTOCAS-2057: Modifying insurance details attached to for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add nominee
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  @Release
  Scenario Outline: ACAUTOCAS-1021: Modifying insurance details attached to for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to save nominee
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  @Release
  Scenario Outline: ACAUTOCAS-2058: Modifying insurance details attached to for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add multiple nominees
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  @Release
  Scenario Outline: ACAUTOCAS-1023: Modifying insurance details attached to for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add nominees with more than 100% entitlement
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  @Release
  Scenario Outline:ACAUTOCAS-1024: Modifying insurance details attached to for collateral Sub Type <CollateralSubType> to <ProductType> application at <ApplicationStage> stage to add nominee and there address
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
#${ApplicationStage:["DDE","Reconsideration","Credit Approval"]}
  ...
  @Release
  Scenario Outline: ACAUTOCAS-1025: Adding minor nominee without appointee in insurance details of collateral Commercial Equipment to get message
    And user opens an "<ProductType>" application for "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
# ${Category:["shares","bonds","metals"]}
  ...
  @Release
  Scenario Outline:ACAUTOCAS-1026: Commercial Equipment data reconcile to validate if insurance and nominee data was saved properly
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
...
#FeatureID-ACAUTOCAS-234,ACAUTOCAS-5080,ACAUTOCAS-6414
  @Release
  Scenario Outline: ACAUTOCAS-8757: In Commercial Equipment check pagination where more than 10 insurances are added
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user opens Collateral Page for adding new collateral for "<ApplicationStage>"
    And user reads data from the excel file "collateral.xlsx" under sheet "asset_details" and row 44
    And user fills mandatory fields of asset details of collateral sub type
