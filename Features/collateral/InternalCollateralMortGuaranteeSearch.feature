...
Feature: Internal Collateral Mortgage Guarantee Search
...
#Internal Collateral Search
  Scenario Outline: ACAUTOCAS-3136:  Provision to search Mortgage Guarantee as internal collateral of <applicantType> on <ProductType> on <ApplicationStage> at <Collateral_collateralSearch_rowNum>
