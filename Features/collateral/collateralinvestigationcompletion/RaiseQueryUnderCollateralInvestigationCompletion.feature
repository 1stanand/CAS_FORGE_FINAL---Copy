...
Feature:Raise Query in collateral investigation completion
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Raise <NoOfQuery> query to <UserOrTeam> in collateral investigation completion
    ...
    When raise "<NoOfQuery>" query to <UserOrTeam> in collateral investigation completion
    Then "<NoOfQuery>" query should be raised in collateral investigation completion
    Examples:
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Unquery the raised query in collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Reassign the raised query in collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
    And user raise multiple query
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Unquery the multiple raised query in bulk under collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
    And user raise multiple query
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Reassign the multiple raised query in bulk under collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
    And user raise multiple query
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:User can not <Actions> the multiple query in bulk once it <Action> in bulk under collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Reassign the already raised query to the new <TeamOrUser> in collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Assigning more than one query with same Query code to the same <TeamOrUser> is not possible in collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
...
#Validate history with data
  #FeatureID-ACAUTOCAS-14208
  Scenario Outline:Query history records of raise query once query is raised in collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Select the documents to raise query in collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Select the document that needs to be uploaded in collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Select the multiple documents that needs to be uploaded in raise query under collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:user should not assign query to himself in collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
    ...
    Examples:
      ...
      | Valuation          |
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:User can not <Action> the query once it unquery in collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Reassign the multiple raised query in bulk to the new <TeamOrUser> in collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
    And user raise multiple query
    ...
    #FeatureID-ACAUTOCAS-14208
  Scenario Outline:Cancel the raising query process in collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
...
#Check the history after reassign the quey and Unquery
  #FeatureID-ACAUTOCAS-14208
  Scenario Outline:Query history records after reassign the query in collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
    When user raise query
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Query history records after Unquery the query in collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
    When user raise query
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Validation of <Field> field which should <FieldNature> in raise query under collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
  ...
  #FeatureID-ACAUTOCAS-14208
  Scenario Outline:TAT Hold in raise query under collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Field type validation of <Field> field which should <FieldNature> in raise query under collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    When user clicks on Raise Query button
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Search <Rejected_Canceled> application for raising query in collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Raise query grid validation with <Field> field in raise query page under collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
    ...
    Examples:
      ...
      | Valuation          |
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Show the "<NumberOfRows>" rows of raised query in raise query grid under collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
...
#need correction
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Validation of pagination in raise query grid under collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
    And user raise multiple queries
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Validating all Pagination in raise query under collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
    And user raise multiple queries
...
#sort the details in ascending order based on Field
  #FeatureID-ACAUTOCAS-14208
  Scenario Outline:Sorting raised query details in ascending order by <Field> column in raise query under collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
    And user raise multiple queries
...
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Sorting raised query details in descending order by <Field> column in raise query under collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
    And user raise multiple queries
    ...
    Examples:
      ...
      | Valuation          | Query Status      |
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Search raised query by <Field> in raise query under collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
...
#Close minimize history
  #FeatureID-ACAUTOCAS-14208
  Scenario Outline:Close the Query History Records in raise query under collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
    ...
    Examples:
      ...
      | Valuation          |
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Minimize the Query History Records in raise query under collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
    And user raise a query
    ...
    Examples:
      ...
      | Valuation          |
#FeatureID-ACAUTOCAS-14208
  Scenario Outline:Maximize the minimized Query History Records in raise query under collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
    And user raise a query
...
#    Add scenarios for Inactive users and Teams would not be displayed
  #FeatureID-ACAUTOCAS-14208
  Scenario Outline:Raise query to the inactive user in collateral investigation completion
    And user open collateral investigation completion page
    And user open an application which verification type is "<VerificationType>"
    And user clicks on Raise Query button
    And user fills all required fields to raise query
    When raise query to the inactive user in collateral investigation completion
