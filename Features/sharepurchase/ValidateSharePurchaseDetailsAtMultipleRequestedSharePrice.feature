...
Feature: Share Purchase Details At Multiple Requested Share Price Validation
...
Scenario Outline: ACAUTOCAS-18148: Verify <Fields> with Required Button for order type Multiple Requested share price at <ApplicationStage> for a <ProductType> application
...
Scenario Outline: ACAUTOCAS-18149: Check Expand All functionality with <Section> for order type Multiple Requested share price at <ApplicationStage> for a <ProductType> application
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
Scenario Outline: ACAUTOCAS-18150: Validate collapse All functionality with <Section> for order type Multiple Requested share price at <ApplicationStage> for a <ProductType> application
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
Scenario Outline: ACAUTOCAS-18151: Verify if Share Exceution grid is <condition> for order type Multiple Requested share price at <ApplicationStage> for a <ProductType> application
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
Scenario Outline: ACAUTOCAS-18152: Share Execution Grid <ColumnName> verification for order type Multiple Requested share price at <ApplicationStage> for a <ProductType> application
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
Scenario Outline: ACAUTOCAS-18153: Validate + icon on share execution details to be <Condition> for order type Multiple Requested share price at <ApplicationStage> for a <ProductType> application
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
Scenario Outline: ACAUTOCAS-18154: Validate clicking + Icon <Condition> for order type Multiple Requested share price at <ApplicationStage> for a <ProductType> application
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
Scenario Outline: ACAUTOCAS-18155: Validate grid in Expand All mode and <Condition> for order type Multiple Requested share price at <ApplicationStage> for a <ProductType> application
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
Scenario Outline: ACAUTOCAS-18156: Validate <Column> by clicking + button for order type Multiple Requested share price at <ApplicationStage> for a <ProductType> application
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
Scenario Outline: ACAUTOCAS-18157: Validate number of records for order type Multiple Requested share price at <ApplicationStage> for a <ProductType> application
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
Scenario Outline: ACAUTOCAS-18158: Validate Additional Details hyper link to be <Condition> for order type Multiple Requested share price at <ApplicationStage> for a <ProductType> application
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
Scenario Outline: ACAUTOCAS-18159: Validate Additional details modal window for order type Multiple Requested share price at <ApplicationStage> for a <ProductType> application
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
Scenario Outline: ACAUTOCAS-18160: Validate closing of Additional details modal window for order type Multiple Requested share price at <ApplicationStage> for a <ProductType> application
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
Scenario Outline: ACAUTOCAS-18161: In Additional Field section verify first field should be RFF value for order type Multiple Requested share price at <ApplicationStage> for a <ProductType> application
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
Scenario Outline: ACAUTOCAS-18162: Verify option Show Entry with <NoOfRecords> records for order type Multiple Requested share price at <ApplicationStage> for a <ProductType> application
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
Scenario Outline: ACAUTOCAS-18163: Verify <FieldValue> should come from Investor details for order type Multiple Requested share price at <ApplicationStage> for a <ProductType> application
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
Scenario Outline: ACAUTOCAS-18164: Validate Total Executed Amount and <Field> for order type Multiple Requested share price at <ApplicationStage> for a <ProductType> application
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
Scenario Outline: ACAUTOCAS-18165: Share Purchase of investor details data for order type Multiple Requested share price 106 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
Scenario Outline: ACAUTOCAS-18166: Share Purchase of investor details data for order type Multiple Requested share price 103 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18167: Share Purchase of investor details data for order type Multiple Requested share price at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18168: Share Purchase of investor details data for order type Multiple Requested share price 112 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18169: Share Purchase of investor details data for order type Multiple Requested share price 115 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18170: Share Purchase of investor details data for order type Multiple Requested share price 118 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18171: Share Purchase of investor details data for order type Multiple Requested share price 121 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18172: Share Purchase of investor details data for order type Multiple Requested share price 124 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18173: Share Purchase of investor details data for order type Multiple Requested share price 139 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18174: Share Purchase of investor details data for order type Multiple Requested share price 142 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18175: Share Purchase of investor details data for order type Multiple Requested share price 145 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18176: Share Purchase of investor details data for order type Multiple Requested share price 148 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18177: Share Purchase of investor details data for order type Multiple Requested share price 151 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18178: Share Purchase of investor details data for order type Multiple Requested share price 154 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18179: Share Purchase of investor details data for order type Multiple Requested share price 157 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18180: Share Purchase of investor details data for order type Multiple Requested share price 160 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18181: Share Purchase of investor details data for order type Multiple Requested share price 163 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18182: Share Purchase of investor details data for order type Multiple Requested share price 166 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18183: Share Purchase of investor details data for order type Multiple Requested share price 169 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18184: Share Purchase of investor details data for order type Multiple Requested share price 172 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18185: Share Purchase of investor details data for order type Multiple Requested share price 175 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18186: Share Purchase of investor details data for order type Multiple Requested share price 178 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18187: Share Purchase of investor details data for order type Multiple Requested share price 181 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18188: Share Purchase of investor details data for order type Multiple Requested share price 184 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18189: Share Purchase of investor details data for order type Multiple Requested share price 187 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18190: Share Purchase of investor details data for order type Multiple Requested share price 190 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18191: Share Purchase of investor details data for order type Multiple Requested share price 193 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18192: Share Purchase of investor details data for order type Multiple Requested share price at 190 196 199 202 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18193: Share Purchase of investor details data for order type Multiple Requested share price at 190 193 202 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
...
#FeatureID-ACAUTOCAS-16523
Scenario Outline: ACAUTOCAS-18194: Share Purchase of investor details data for order type Multiple Requested share price 190 193 202 at <VarStage2> for a <ProductType> application with <SharePurchase_shareExecution_rowNum>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
    And user reads data from the excel file "<SharePurchaseWB>" under sheet "<SharePurchase_shareExecution>" and row <SharePurchase_shareExecution_rowNum>
    And user open investor details tab
    When user fills all fields to add investor details for share execution
