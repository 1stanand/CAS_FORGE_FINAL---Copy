...
#ReviewedBy:
#Scenarios:
Feature: Configuration verification for config.view.column.layout with value 2
...
#FeatureID-ACAUTOCAS-8505,CAS-120070
  Scenario Outline: ACAUTOCAS-13658:  Column layout validation 2 for corporate rating screen of non individual customer of <ProductType> application at <ApplicationStage> stage
    ...
    Then user should be able to see fields arranged in 2 columns
