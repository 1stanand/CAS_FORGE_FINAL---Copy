...
#Scenarios:
@ConfigRequired
Feature: Configuration verification for config.view.column.layout with value 3
...
#FeatureID-ACAUTOCAS-8505,CAS-120070
  Scenario Outline: ACAUTOCAS-13659:  Column layout validation 3 for corporate rating screen of non individual customer of <ProductType> application at <ApplicationStage> stage
    ...
    Then user should be able to see fields arranged in 3 columns
