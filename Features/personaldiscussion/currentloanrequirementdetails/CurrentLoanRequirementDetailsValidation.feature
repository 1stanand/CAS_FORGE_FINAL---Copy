...
Feature:Current Loan Requirement Details Validation In Personal Discussion Sales Page

  @Sanity
  Scenario Outline: ACAUTOCAS-1960: Fill all current loan requirement details
    ...
    Examples:
      | SourceDataFile       | SheetName | RowNumber | PersonalInfoWB            | PersonalInfo_home | PersonalInfo_home_rowNum | SourcingDetailsWB     | SourcingDetails_home | SourcingDetails_home_rowNum | PersonalDiscussionWB     | PersonalDiscussion_current_loan_requirement | PersonalDiscussion_rowNum |
