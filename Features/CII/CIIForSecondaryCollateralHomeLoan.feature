...
Feature: Collateral Investigation Initiation For Secondary Collateral Of home loan
  ...
  Scenario Outline: Validation of successful verification initiation with single agency in CII for secondary collateral <collateral_sub_type> of home loan application
    And application has secondary collateral with collateral subtype as "<collateral_sub_type>"
    ...
    Examples:
      ...
      | Commercial Equipment                | 3       |
          ...
          #FeatureID-ACAUTOCAS-368
  Scenario Outline: Validation of successful verification initiation with multiple agencies in CII for secondary collateral <collateral_sub_type> of home loan application
    And application has secondary collateral with collateral subtype as "<collateral_sub_type>"
    And verification valuation for the collateral is not initiated yet
    When user selects the home loan application of CII stage
    And user selects initiate Valuation Verification
    ...
    Examples:
      ...
      | Commercial Equipment                | 4       |
          ...
          #FeatureID-ACAUTOCAS-368
  Scenario Outline: Validation of unsuccessful verification initiation with duplicate agencies in CII for secondary collateral <collateral_sub_type> of home loan application
    And application has secondary collateral with collateral subtype as "<collateral_sub_type>"
    And verification valuation for the collateral is not initiated yet
    When user selects the home loan application of CII stage
    And user selects initiate Valuation Verification
...
#FeatureID-ACAUTOCAS-368
  Scenario Outline: Validation of successfully delete multiple verifications in CII for secondary collateral <collateral_sub_type> of home loan application
    And application has secondary collateral with collateral subtype as "<collateral_sub_type>"
    And verification valuation for the collateral is not initiated yet
    When user selects the home loan application of CII stage
    And user selects initiate Valuation Verification
    ...
    #Valuation
   # FeatureID-ACAUTOCAS-368
  Scenario Outline: Validation of successful valuation initiation with single agency in CII for secondary collateral <collateral_sub_type> of home loan application
    And application has secondary collateral with collateral subtype as "<collateral_sub_type>"
    And verification valuation for the collateral is not initiated yet
    When user selects the home loan application of CII stage
    And user selects initiate Valuation Verification
    ...
    Examples:
      ...
      #data is not prepared yet
          #FeatureID-ACAUTOCAS-368
  Scenario Outline: Validation of successful valuation initiation with multiple agencies in CII for secondary collateral <collateral_sub_type> of home loan application
    And application has secondary collateral with collateral subtype as "<collateral_sub_type>"
    And verification valuation for the collateral is not initiated yet
    When user selects the home loan application of CII stage
    And user selects initiate Valuation Verification
    ...
    Examples:
      ...
      #data is not prepared yet
          #FeatureID-ACAUTOCAS-368
  Scenario Outline: Validation of unsuccessful valuation initiation with duplicate valuation in CII for secondary collateral <collateral_sub_type> of home loan application
    And application has secondary collateral with collateral subtype as "<collateral_sub_type>"
    And verification valuation for the collateral is not initiated yet
    When user selects the home loan application of CII stage
    And user selects initiate Valuation Verification
 ...
 #FeatureID-ACAUTOCAS-368
  Scenario Outline: Validation of successfully delete multiple valuation in CII for secondary collateral <collateral_sub_type> of home loan application
    And application has secondary collateral with collateral subtype as "<collateral_sub_type>"
    And verification valuation for the collateral is not initiated yet
    When user selects the home loan application of CII stage
    And user selects initiate Valuation Verification
...
#FeatureID-ACAUTOCAS-368
  Scenario Outline:Validate waive off verification reason in CII for secondary collateral <collateral_sub_type> of home loan application
    And application has secondary collateral with collateral subtype as "<collateral_sub_type>"
    And verification valuation for the collateral is not initiated yet
    ...
    #FeatureID-ACAUTOCAS-368
  Scenario Outline:Validate successful waive off verification in CII for secondary collateral <collateral_sub_type> of home loan application
    And application has secondary collateral with collateral subtype as "<collateral_sub_type>"
    And verification valuation for the collateral is not initiated yet
    And reasons for waive off verification is configured in masters
    When user selects the home loan application of CII stage
    ...
    #FeatureID-ACAUTOCAS-368
  Scenario Outline:Validate successful waive off verification with multiple reasons in CII for secondary collateral <collateral_sub_type> of home loan application
    And application has secondary collateral with collateral subtype as "<collateral_sub_type>"
    And verification valuation for the collateral is not initiated yet
    And reasons for waive off verification is configured in masters
    When user selects the home loan application of CII stage
  ...
  #FeatureID-ACAUTOCAS-368
  Scenario Outline:Validate unsuccessful waive off verification with duplicate reasons in CII for secondary collateral <collateral_sub_type> of home loan application
    And application has secondary collateral with collateral subtype as "<collateral_sub_type>"
    And verification valuation for the collateral is not initiated yet
    And reasons for waive off verification is configured in masters
    When user selects the home loan application of CII stage
