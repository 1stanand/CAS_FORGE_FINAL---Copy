...
Feature: punching personal loan stages upto DDE

  Scenario Outline: ACAUTOCAS-13925:  personal loan punch at DDE
    ...
    Examples:
      ...
      | LoginDetailsCAS.xlsx | LoginData | 11        | personal_loan_punch.xlsx | lead_details                  | 0                                    | loan_details                  | 0                                    |kyc                   | 0                                    | dde                   | 0                                    |
      | LoginDetailsCAS.xlsx | LoginData | 11        | personal_loan_punch.xlsx | lead_details                  | 0                                    | loan_details                  | 0                                    |kyc                   | 0                                    | dde                   | 0                                    |
      | LoginDetailsCAS.xlsx | LoginData | 11        | personal_loan_punch.xlsx | lead_details                  | 0                                    | loan_details                  | 0                                    |kyc                   | 0                                    | dde                   | 0                                    |
