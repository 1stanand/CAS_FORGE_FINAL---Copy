...
@Islamic
  ...
  #Prerequisite:
  # 1) Need analysis checklist for group level should be maintained in Masters
...
Feature: Field Data Validation of all questions of group level form in need analysis section
...
# Prerequisite: Questions of questionType amount , date , numeric and Yes/No should be set to mandatory in Masters
  ...
  Scenario Outline:Show error when saving need analysis details without filling <Mandatory_Question> of <QuestionType> in group level need analysis checklist at "<ApplicationStage>" of "<ProductType>"
...
# Prerequisite: Questions of questionType amount , date , numeric and Yes/No should be set to mandatory in Masters
  ...
  @ImplementedBy-anshika.gupta
   ...
   #FeatureID-ACAUTOCAS-121
    @Sanity
  Scenario Outline: Saving need analysis details after filling <Question> questions in group level need analysis checklist at "<ApplicationStage>" of "<ProductType>"
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user clicks on need analysis tab
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
  ...
  @ImplementedBy-anshika.gupta
    @Release
   #FeatureID-ACAUTOCAS-121
  Scenario Outline: "<QuestionType>" type validation of group level need analysis checklist <Question_Name> at <ApplicationStage> for <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
  ...
  @ImplementedBy-anshika.gupta
    @Release
   #FeatureID-ACAUTOCAS-121
  Scenario Outline: Email ID field validation with <Validity> data on the group level need analysis page at <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
...
#               2) Ensure that in the master data , values(city) should be mapped for Question with question type 'Reference'.
  ...
  @ImplementedBy-anshika.gupta
    @Release
   #FeatureID-ACAUTOCAS-121
  Scenario Outline: Validation of "<QuestionType>" type field with <Validity> <InputType> in group level need analysis detail at <ApplicationStage> for <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user clicks on need analysis tab
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
 ...
 #Prerequisite:1) Ensure that in the master data ,Question with question type 'Date' is maintained  with the "Allow future date" setting disabled.
  ...
  @ImplementedBy-anshika.gupta
    @Release
   #FeatureID-ACAUTOCAS-121
  Scenario Outline: Validation of Date Question Type field with <Validity> <InputType> in group level need analysis detail that allows future dates at <ApplicationStage> for <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user clicks on need analysis tab
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
...
# Prerequisite: Questions of questionType amount , date , numeric and Yes/No should be set to mandatory in Masters
  ...
  @ImplementedBy-anshika.gupta
    @Release
   #FeatureID-ACAUTOCAS-121
  Scenario Outline: Show error when saving need analysis details without filling <Mandatory_Question> of <QuestionType> in group level need analysis checklist at "<ApplicationStage>" of "<ProductType>" which starts from DDE stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user clicks on need analysis tab
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    When user fills the need analysis checklist except "<Mandatory_Question>" of "<QuestionType>"
...
# Prerequisite: Questions of questionType amount , date , numeric and Yes/No should be set to mandatory in Masters
  ...
  @ImplementedBy-anshika.gupta
    @Release
   #FeatureID-ACAUTOCAS-121
  Scenario Outline: Saving need analysis details after filling <Question> questions in group level need analysis checklist at "<ApplicationStage>" of "<ProductType>" which starts from DDE stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user clicks on need analysis tab
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user fills the need analysis checklist with "<Question>" questions
  ...
  @ImplementedBy-anshika.gupta
    @Release
   #FeatureID-ACAUTOCAS-121
  Scenario Outline: "<QuestionType>" type validation of group level need analysis checklist <Question_Name> at <ApplicationStage> for <ProductType> which starts from DDE stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    When user clicks on need analysis tab
    Then "<Question_Name>" question should be of "<QuestionType>" type in need analysis checklist
    Examples:
 ...
 # ${ProductType:["BG","LC","BL","CashCred","BD","MULF","FAS","CFL","GL","JLG","SHG","CL"]}
  ...
  @ImplementedBy-anshika.gupta
    @Release
   #FeatureID-ACAUTOCAS-121
  Scenario Outline: Email ID field validation with <Validity> data on the group level need analysis page at <ApplicationStage> of <ProductType> which starts from DDE stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user fills the need analysis detail
...
#               2) Ensure that in the master data , values(city) should be mapped for Question with question type 'Reference'.
  ...
  @ImplementedBy-anshika.gupta
    @Release
  #FeatureID-ACAUTOCAS-121
  Scenario Outline: Validation of "<QuestionType>" type field  with <Validity> <InputType> in group level need analysis detail at <ApplicationStage> for <ProductType> which starts from DDE stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user clicks on need analysis tab
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    When user fills "<Validity>" data in "<QuestionType>" type field with "<InputType>" in need analysis detail
...
#Prerequisite:1) Ensure that in the master data ,Question with question type 'Date' is maintained  with the "Allow future date" setting disabled.
  ...
  @ImplementedBy-anshika.gupta
    @Release
  #FeatureID-ACAUTOCAS-121
  Scenario Outline: Validation of Date Question Type field with <Validity> <InputType> in group level need analysis detail  that allows future dates at <ApplicationStage> for <ProductType> which starts from DDE stage
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user clicks on need analysis tab
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    When user fills "<Validity>" data in "Date" type field with "<InputType>" in need analysis detail
    ...
    Examples:
      | ProductType   | Validity | InputType                      | Throws_notThrows | ApplicationStage   | ApplicantType   | ActivityWB    | Activity_needAnalysisDetails | Activity_needAnalysisDetails_rowNum |
      | <ProductType> | valid    | correct date format            | not throw any    | Lead Details       | indiv           | activity.xlsx | need_analysis                | 30                                  |
      | <ProductType> | invalid  | incorrect date format          | throw an         | <ApplicationStage> | <ApplicantType> | activity.xlsx | need_analysis                | 31                                  |
      | <ProductType> | valid    | less than current date         | not throw any    | <ApplicationStage> | <ApplicantType> | activity.xlsx | need_analysis                | 32                                  |
      | <ProductType> | invalid  | greater than current date      | throw an         | <ApplicationStage> | <ApplicantType> | activity.xlsx | need_analysis                | 33                                  |
      | <ProductType> | valid    | Year of date greater than 1942 | not throw any    | <ApplicationStage> | <ApplicantType> | activity.xlsx | need_analysis                | 34                                  |
      ...
      | <ProductType> | invalid  | only numbers                   | throw an         | <ApplicationStage> | <ApplicantType> | activity.xlsx | need_analysis                | 37                                  |
      | <ProductType> | invalid  | characters                     | throw an         | <ApplicationStage> | <ApplicantType> | activity.xlsx | need_analysis                | 14                                  |
      | <ProductType> | invalid  | special characters             | throw an         | Lead Details       | indiv           | activity.xlsx | need_analysis                | 15                                  |
      | <ProductType> | invalid  | alphanumeric                   | throw an         | <ApplicationStage> | <ApplicantType> | activity.xlsx | need_analysis                | 16                                  |
