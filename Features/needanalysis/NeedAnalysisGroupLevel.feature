...
Feature: Need Analysis Group Level Screen Validation
  ...
  @Sanity
  Scenario Outline: Save need analysis details for group level at "<ApplicationStage>" of "<ProductType>"
  ...
  ###Bug:CAS-135641
  #FeatureID-ACAUTOCAS-121
  Scenario Outline: Validation of application number generation after saving need analysis details for group level at "<ApplicationStage>" of "<ProductType>"
    Given user is on CAS Login Page
  ...
  # ${ApplicantType:["indiv","nonindiv"]}
  # FeatureID-ACAUTOCAS-121
  Scenario Outline: Verify all captured data is refreshed on re-execution of need analysis checklist for group level at <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
...
#Prerequisite: Update the Need analysis checklist in Masters before re-execution
  ...
  # ${ApplicantType:["indiv","nonindiv"]}
  # FeatureID-ACAUTOCAS-121
  Scenario Outline: Verify updated need analysis checklist on re-execution of need analysis checklist for group level at <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    When user re-executes the need analysis checklist
  ...
  # ${ProductType:["PF","HL","AL","IHF","IAF","IPF","EDU","OMNI","CEQ","KCC","AGRL","FE","MHL","CV","CC","LAP"]}
   ...
   #${ApplicantType:["indiv","nonindiv"]}
   # FeatureID-ACAUTOCAS-121
  Scenario Outline: Validation of creation timestamp in need analysis history section after re-executing need analysis checklist for group level at <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
  ...
  # ${ProductType:["PF","HL","AL","IHF","IAF","IPF","EDU","OMNI","CEQ","KCC","AGRL","FE","MHL","CV","CC","LAP"]}
   ...
   #${ApplicantType:["indiv","nonindiv"]}
   # FeatureID-ACAUTOCAS-121
  Scenario Outline: Validation of need analysis details in need analysis history section after re-executing need analysis checklist for group level at <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
   ...
   # ${ApplicationStage:["Lead Details"]}
   # FeatureID-ACAUTOCAS-121
  Scenario Outline: Validate if need analysis details for group level can be cancelled at "<ApplicationStage>" of "<ProductType>"
    And user create new application for "<ProductType>"
    And user click on need analysis tab for "<ProductType>" at "<ApplicationStage>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
  ...
  # ${ApplicationStage:["Lead Details"]}
   ...
   ###Squash:10_CAS-74864
   # FeatureID-ACAUTOCAS-121
  Scenario Outline: Validate if need analysis details for group level can be printed at <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
  ...
  # ${ApplicationStage:["Lead Details"]}
   ...
   ###Squash:11_CAS-74864
   # FeatureID-ACAUTOCAS-121
  Scenario Outline: Send email after filling details on the need analysis page for group level at <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
...
# ${ProductType:["PF","HL","AL","IHF","IAF","IPF","EDU","OMNI","CEQ","KCC","AGRL","FE","MHL","CV","CC","LAP"]}
  ...
  Scenario Outline: Validation of cancel button in email address modal on the need analysis page for group level at <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
  ...
  # ${ApplicationStage:["Lead Details"]}
   ...
   # FeatureID-ACAUTOCAS-121
  Scenario Outline: Save need analysis details as draft for group level at <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
  ...
  # ${ApplicationStage:["Lead Details"]}
   #${ApplicantType:["indiv","nonindiv"]}
   # FeatureID-ACAUTOCAS-121
  Scenario Outline: Show error message when saving an unfilled need analysis checklist as draft for group level <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
  ...
  # ${ApplicationStage:["Lead Details"]}
   ...
   ###Squash:09_CAS-74864
   # FeatureID-ACAUTOCAS-121
  Scenario Outline: Validation of Save as PDF action on need analysis page for group level at <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
  ...
  # ${ApplicationStage:["Lead Details"]}
   ...
   # FeatureID-ACAUTOCAS-121
  Scenario Outline: Validation of need analysis tab for group level at <ApplicationStage> of <ProductType>
...
#Prerequisite: Lead Detail Stage should be configured in cancelled applications from workflow configuration
   ...
   # ${ApplicationStage:["Lead Details"]}
    #${ApplicantType:["indiv","nonindiv"]}
   # FeatureID-ACAUTOCAS-121
  Scenario Outline: View need analysis data for group level in cancelled applications grid after cancelling application at <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
...
#Prerequisite: Lead Detail Stage should be configured in cancelled applications from workflow configuration
  ...
  #${ApplicantType:["indiv","nonindiv"]}
   #FeatureID-ACAUTOCAS-121
  Scenario Outline: Validation of need analysis details for group level in cancelled applications grid after cancelling application at <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
...
#Prerequisite: Lead Detail Stage should be configured in rejected applications from workflow configuration
  ...
  #${ApplicantType:["indiv","nonindiv"]}
  #FeatureID-ACAUTOCAS-121
  Scenario Outline: View need analysis data for group level in rejected applications grid after rejecting application at <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
...
#Prerequisite: Lead Detail Stage should be configured in rejected applications from workflow configuration
  ...
  #${ApplicantType:["indiv","nonindiv"]}
   #FeatureID-ACAUTOCAS-121
  Scenario Outline: Validation of need analysis details for group level in rejected applications grid after rejecting application at <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
  ...
  #${ApplicantType:["indiv","nonindiv"]}
   #FeatureID-ACAUTOCAS-121
  Scenario Outline: Validation of need analysis details for group level in hold applications grid after putting the application on hold at <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
  ...
  #${ApplicantType:["indiv","nonindiv"]}
   #FeatureID-ACAUTOCAS-121
  Scenario Outline: View need analysis data for group level in hold applications grid after putting the application on hold at <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
  ...
  #${ApplicantType:["indiv","nonindiv"]}
  # FeatureID-ACAUTOCAS-121
  Scenario Outline: Validation of need analysis details in application enquiry screen of an application for group level at <ApplicationStage> of <ProductType>
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
  ...
  #${ApplicantType:["indiv","nonindiv"]}
   #FeatureID-ACAUTOCAS-121
  Scenario Outline: View need analysis data in application enquiry screen for group level of an application at "<ApplicationStage>" of "<ProductType>"
    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" from application grid
    And user click on need analysis tab for "<ProductType>"
    And user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
...
#Prerequisite: Need analysis is set to Mandatory
   # ${ProductType:["PF","HL","AL","IHF","IAF","IPF","EDU","OMNI","CEQ","KCC","AGRL","FE","MHL","CV","CC","LAP"]}
    ###Squash:11_CAS-67507
  #FeatureID-ACAUTOCAS-121
  Scenario Outline: Verify tabs should be in disabled mode except need analysis tab for group level at Lead Details stage after punching an application of "<ProductType>"
...
#Prerequisite: Need analysis is set to Mandatory
  ...
  ###Squash:11_CAS-67507
  #FeatureID-ACAUTOCAS-121
  Scenario Outline: Verify need analysis tab for group level should be in enabled mode at Lead Details stage after punching an application of <ProductType>
    When user create new application for "<ProductType>"
   ...
   ###Squash:07_CAS-72391
  #FeatureID-ACAUTOCAS-121
  Scenario Outline: Verify if all tabs should get activated at Lead Details stage after saving need analysis details for group level of <ProductType>
    And user create new application for "<ProductType>"
    And  user reads data from the excel file "<ActivityWB>" under sheet "<Activity_needAnalysisDetails>" and row <Activity_needAnalysisDetails_rowNum>
    And user reply to the questions of group level form in need analysis detail page
    When user saves the need analysis details
