...
Feature: Swap QC screen validation
...
#Squash:05_CAS-101154
#StoryID:CAS-101154
  #FeatureID - ACAUTOCAS-10860, CAS-101154
  # ${ ProductType : ["FAS"]}
  #${ApplicationStage : ["SWAP QC"]}
...
#StoryID:CAS-101154
  ...
  Scenario Outline: <FieldName> field validation on <ApplicationStage> in <ProductType>
    ...
    Examples:
      ...
      | <ApplicationStage> | <ProductType>  | Swap_QC_Stage_Decision.xlsx | Negative              | 0                            | Reason        |
      | <ApplicationStage> | <ProductType>  | Swap_QC_Stage_Decision.xlsx | Negative              | 1                            | Description   |
      | <ApplicationStage> | <<ProductType> | Swap_QC_Stage_Decision.xlsx | Negative              | 2                            | DecisionSheet |
...
#StoryID:CAS-101154
  ...
  Scenario Outline: validate cancellation of data entered in stage decision tab
    ...
    Examples:
      ...
      | <ApplicationStage> | <ProductType> | Swap_QC_Stage_Decision.xlsx | Cancel                | 0                            |
      | <ApplicationStage> | <ProductType> | Swap_QC_Stage_Decision.xlsx | Cancel                | 1                            |
      | <ApplicationStage> | <ProductType> | Swap_QC_Stage_Decision.xlsx | Cancel                | 2                            |
      | <ApplicationStage> | <ProductType> | Swap_QC_Stage_Decision.xlsx | Cancel                | 3                            |
      | <ApplicationStage> | <ProductType> | Swap_QC_Stage_Decision.xlsx | Cancel                | 4                            |
      | <ApplicationStage> | <ProductType> | Swap_QC_Stage_Decision.xlsx | Cancel                | 5                            |
...
#StoryID:CAS-101154
  ...
  Scenario Outline: Validate approval of record at <ApplicationStage>
    ...
    Examples:
      | ApplicationStage   | ProductType   | StageDecisionWB             | StageDecision_default | StageDecision_default_rowNum |
      | <ApplicationStage> | <ProductType> | Swap_QC_Stage_Decision.xlsx | Save                  | 0                            |
...
#StoryID:CAS-101154
  ...
  Scenario Outline:  Validate rejection of record at <ApplicationStage>
    ...
    Examples:
      | ApplicationStage   | ProductType   | StageDecisionWB             | StageDecision_default | StageDecision_default_rowNum |
      | <ApplicationStage> | <ProductType> | Swap_QC_Stage_Decision.xlsx | Save                  | 1                            |
...
#StoryID:CAS-101154
  ...
  Scenario Outline: Validation of send back of record at <ApplicationStage>
    ...
    Examples:
      | ApplicationStage   | ProductType   | StageDecisionWB             | StageDecision_default | StageDecision_default_rowNum |
      | <ApplicationStage> | <ProductType> | Swap_QC_Stage_Decision.xlsx | Save                  | 2                            |
