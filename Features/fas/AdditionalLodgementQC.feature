...
@ADDITIONALLODGEMENTQC

Feature: Additional Lodgement QC screen validation
...
#Squash:04_CAS-119534
#StoryID:CAS-119534
  #FeatureID - ACAUTOCAS-10855, CAS-119534
  # ${ ProductType : ["FAS"]}
  #${ApplicationStage : ["ADDITIONAL LODGEMENT QC"]}
