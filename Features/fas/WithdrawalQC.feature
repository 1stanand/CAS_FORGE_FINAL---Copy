...
Feature: Withdrawal QC screen validation
...
#  In this feature we will validate all these screen level validation with User who is having ALL_Roles Authority
  ...
  Background:
    ...
    #Squash:05_CAS-101108
#StoryID:CAS-101108
  #FeatureID - ACAUTOCAS-10857, CAS-101108
  # ${ ProductType : ["FAS"]}
  #${ApplicationStage : ["WITHDRAWAL QC"]}
...
#StoryID:CAS-101108
  ...
  Scenario Outline: <FieldName> field validation on <ApplicationStage> in <ProductType>
    ...
    Examples:
      ...
      | <ApplicationStage> | <ProductType>  | Withdrawal_QC_Stage_Decision.xlsx | Negative              | 0                            | Reason        |
      | <ApplicationStage> | <ProductType>  | Withdrawal_QC_Stage_Decision.xlsx | Negative              | 1                            | Description   |
      | <ApplicationStage> | <<ProductType> | Withdrawal_QC_Stage_Decision.xlsx | Negative              | 2                            | DecisionSheet |
...
#StoryID:CAS-101108
  ...
  Scenario Outline: validate cancellation of data entered in stage decision tab
    ...
    Examples:
      ...
      | <ApplicationStage> | <ProductType> | Withdrawal_QC_Stage_Decision.xlsx | Cancel                | 0                            |
      | <ApplicationStage> | <ProductType> | Withdrawal_QC_Stage_Decision.xlsx | Cancel                | 1                            |
      | <ApplicationStage> | <ProductType> | Withdrawal_QC_Stage_Decision.xlsx | Cancel                | 2                            |
      | <ApplicationStage> | <ProductType> | Withdrawal_QC_Stage_Decision.xlsx | Cancel                | 3                            |
      | <ApplicationStage> | <ProductType> | Withdrawal_QC_Stage_Decision.xlsx | Cancel                | 4                            |
      | <ApplicationStage> | <ProductType> | Withdrawal_QC_Stage_Decision.xlsx | Cancel                | 5                            |
...
#StoryID:CAS-101108
  ...
  Scenario Outline: Validate approval of record at <ApplicationStage>
    ...
    Examples:
      | ApplicationStage   | ProductType   | StageDecisionWB                   | StageDecision_default | StageDecision_default_rowNum |
      | <ApplicationStage> | <ProductType> | Withdrawal_QC_Stage_Decision.xlsx | Save                  | 0                            |
...
#StoryID:CAS-101108
  ...
  Scenario Outline:  Validate rejection of record at <ApplicationStage>
    ...
    Examples:
      | ApplicationStage   | ProductType   | StageDecisionWB                   | StageDecision_default | StageDecision_default_rowNum |
      | <ApplicationStage> | <ProductType> | Withdrawal_QC_Stage_Decision.xlsx | Save                  | 1                            |
...
#StoryID:CAS-101108
  ...
  Scenario Outline: Validation of send back of record at <ApplicationStage>
    ...
    Examples:
      | ApplicationStage   | ProductType   | StageDecisionWB                   | StageDecision_default | StageDecision_default_rowNum |
      | <ApplicationStage> | <ProductType> | Withdrawal_QC_Stage_Decision.xlsx | Save                  | 2                            |
...
#StoryID:CAS-101108
  ...
  # ${ ProductType : ["FAS"]}
  #${ApplicationStage : ["WITHDRAWAL QC"]}
  Scenario Outline: Verify required fields is visible on <ApplicationStage> in <ProductType>
    And user opens "<ProductType>" application at "<ApplicationStage>"
    And user opens stage decision tab
