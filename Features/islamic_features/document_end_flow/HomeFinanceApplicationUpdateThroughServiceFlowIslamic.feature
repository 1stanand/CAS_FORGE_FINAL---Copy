...
Feature: Capturing_Document_Through_Application_Update_Service_Home_Finance_Flow

Scenario: ACAUTOCAS-15716: User should be able to disburse the home finance successfully with changing the document status through application service
