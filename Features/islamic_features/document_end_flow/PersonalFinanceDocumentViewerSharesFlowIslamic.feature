...
Feature: Document_Viewer_Personal_Finance_Shares_Flow

Scenario: ACAUTOCAS-15924: User should be able to disburse the personal finance shares flow successfully with document viewer features
