...
Feature: Capturing_Copy_Application_Document_Personal_Finance_Shares_Flow

Scenario: ACAUTOCAS-15747: User should be able to disburse the personal finance shares flow successfully with document status updated through application service
