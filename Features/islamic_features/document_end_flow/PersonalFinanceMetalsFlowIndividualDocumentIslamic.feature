...
Feature: Capturing_Individual_Document_Personal_Finance_Metals_Flow_Islamic

Scenario: ACAUTOCAS-15864: User should be able to disburse the metals flow personal finance successfully with individual document status updated
...
#    And user saves Add view Bank details
    ...
    And user reads data from the excel file "sourcing_details_end_flow.xlsx" under sheet "home" and row 5
