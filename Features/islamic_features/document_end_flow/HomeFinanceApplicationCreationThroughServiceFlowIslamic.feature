...
Feature: Capturing_Document_Through_Application_Creation_Service_Home_Finance_Flow

Scenario: ACAUTOCAS-15713: User should be able to disburse the home finance successfully with document status updated through application service
