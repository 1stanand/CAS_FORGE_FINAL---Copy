...
Feature: Capturing_Copy_Application_Document_Personal_Finance_Bonds_Flow

Scenario: ACAUTOCAS-15746: User should be able to disburse the personal finance bonds flow successfully with document status updated through application service
