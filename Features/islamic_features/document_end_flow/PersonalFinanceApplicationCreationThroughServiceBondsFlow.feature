...
Feature: Capturing_Document_Through_Application_Creation_Service_Personal_Finance_Bonds_Flow

Scenario: ACAUTOCAS-15751: User should be able to disburse the personal finance bonds flow successfully with document status updated through application service
