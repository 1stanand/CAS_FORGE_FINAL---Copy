...
Feature: Capturing_Document_Through_Application_Update_Service_Personal_Finance_Bonds_Flow

Scenario: ACAUTOCAS-15728: User should be able to disburse the personal finance bonds flow successfully with changing the document status through application service
    Given user is on CAS Login Page
    And user logged in CAS with valid username and password present in "LoginDetailsCAS.xlsx" under "LoginData" and 0
    When user creates an application of "IPF" product type as "indiv" applicant at "sourcing" for "bonds" with "e2esingle" from web service
    And user opens an application of "IPF" product type as "indiv" applicant at "sourcing" for "bonds" with "e2esingle" from application grid
