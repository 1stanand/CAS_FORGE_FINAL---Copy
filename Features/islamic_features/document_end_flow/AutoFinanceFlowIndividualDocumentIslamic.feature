...
@Islamic
@Release @E2E
#FeatureID-ACAUTOCAS-15175
Feature: Capturing_Individual_Document_Auto_Finance_Flow

Scenario: ACAUTOCAS-15714: User should be able to disburse the Auto finance successfully with individual document status updated
    Given user is on CAS Login Page
    And user logged in CAS with valid username and password present in "LoginDetailsCAS.xlsx" under "LoginData" and 0
    When user create new application for "Auto Finance"
...
#    And user saves Add view Bank details
    ...
    And user reads data from the excel file "sourcing_details_end_flow.xlsx" under sheet "home" and row 7
    And user enters all required details on Sourcing Details screen
    #asset details
    And user reads data from the excel file "asset_details.xlsx" under sheet "home" and row 73
    And user fills asset Details "New Asset" with "Mandatory" and save it
    #asset details end
    And user selects document tab
    And user selects the document with document status
      | document_end_flow.xlsx | individual_documents | 0 |
      | document_end_flow.xlsx | individual_documents | 1 |
      | document_end_flow.xlsx | individual_documents | 2 |
      | document_end_flow.xlsx | individual_documents | 3 |
    ...
    And user should be able to verify document status in next stage
      ...
      | document_end_flow.xlsx | individual_documents | 3 |
    And user selects the document with document status
      | document_end_flow.xlsx | individual_documents | 4 |
      | document_end_flow.xlsx | individual_documents | 5 |
      | document_end_flow.xlsx | individual_documents | 6 |
      | document_end_flow.xlsx | individual_documents | 7 |
    ...
    And user should be able to verify document status in next stage
      ...
      | document_end_flow.xlsx | individual_documents | 6 |
      | document_end_flow.xlsx | individual_documents | 7 |
    And user reads data from the excel file "document_end_flow.xlsx" under sheet "individual_documents" and row 8
    ...
    And user submit the documents with wait
    And user reads data from the excel file "document_end_flow.xlsx" under sheet "individual_documents" and row 9
    And user selects the document
    And user select the documents status as "Received"
    ...
    And user reads data from the excel file "document_end_flow.xlsx" under sheet "individual_documents" and row 23
...
#    And user search assigned application from context in document approval grid
    ...
    And user selects document tab
    And user selects the document with document status
      | document_end_flow.xlsx | individual_documents | 10 |
      | document_end_flow.xlsx | individual_documents | 11 |
      | document_end_flow.xlsx | individual_documents | 12 |
      | document_end_flow.xlsx | individual_documents | 13 |
    And user submit the documents with wait
    And user should be able to verify document status in next stage
      | document_end_flow.xlsx | individual_documents | 10 |
      | document_end_flow.xlsx | individual_documents | 11 |
      | document_end_flow.xlsx | individual_documents | 12 |
      | document_end_flow.xlsx | individual_documents | 13 |
    And user reads data from the excel file "document_end_flow.xlsx" under sheet "individual_documents" and row 29
    And user selects the document
    And user selects document status as "Received"
...
#    And user switch and close next tab
    ...
    And user marks bulk status of selected parent document
      | document_end_flow.xlsx | individual_documents | 24 |
      | document_end_flow.xlsx | individual_documents | 25 |
      | document_end_flow.xlsx | individual_documents | 26 |
      | document_end_flow.xlsx | individual_documents | 27 |
    And user submit the document
    And user should be able to verify document status in next stage
      | document_end_flow.xlsx | individual_documents | 24 |
      | document_end_flow.xlsx | individual_documents | 25 |
    ...
    And user selects the document with document status
      ...
      | document_end_flow.xlsx | individual_documents | 2 |
      | document_end_flow.xlsx | individual_documents | 3 |
    And user reads data from the excel file "document_end_flow.xlsx" under sheet "individual_documents" and row 5
    And user selects the document
...
#    And document should be downloaded successfully
    ...
    And user should be able to verify document status in next stage
      ...
      | document_end_flow.xlsx | individual_documents | 24 |
      | document_end_flow.xlsx | individual_documents | 25 |
      | document_end_flow.xlsx | individual_documents | 8  |
      | document_end_flow.xlsx | individual_documents | 9  |
      | document_end_flow.xlsx | individual_documents | 11 |
      | document_end_flow.xlsx | individual_documents | 12 |
      | document_end_flow.xlsx | individual_documents | 13 |
      | document_end_flow.xlsx | individual_documents | 26 |
