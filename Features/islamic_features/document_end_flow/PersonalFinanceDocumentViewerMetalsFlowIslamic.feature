...
Feature: Document_Viewer_Personal_Finance_Metals_Flow

  Scenario: ACAUTOCAS-15748: User should be able to disburse the personal finance metals flow successfully with document viewer features
