...
Feature: Capturing_Copy_Application_Document_Personal_Finance_Metals_Flow

Scenario: ACAUTOCAS-15745: User should be able to disburse the personal finance metals flow successfully with document status updated through application service
