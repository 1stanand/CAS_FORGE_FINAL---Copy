...
Feature: Capturing_Document_Through_Application_Creation_Service_Auto_Finance_Flow

Scenario: ACAUTOCAS-15694: User should be able to disburse the auto finance successfully with document status updated through application service
