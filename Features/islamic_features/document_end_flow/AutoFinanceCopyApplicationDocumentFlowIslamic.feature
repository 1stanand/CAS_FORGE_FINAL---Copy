...
Feature: Capturing_Copy_Application_Document_Auto_Finance_Flow

Scenario: ACAUTOCAS-15696: User should be able to disburse the auto finance successfully with document status updated through application service
