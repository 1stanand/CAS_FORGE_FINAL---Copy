...
Feature: Capturing_Group_Document_Auto_Finance_Flow

  Scenario: ACAUTOCAS-15718: User should be able to disburse the auto finance successfully with group document status updated
...
#    And user reads data from the excel file "document_end_flow.xlsx" under sheet "document_approval" and row 0
...
#    And user switch and close next tab
    ...
    And user selects the document with document status
      ...
      | document_end_flow.xlsx | group_documents | 2 |
      | document_end_flow.xlsx | group_documents | 3 |
    And user reads data from the excel file "document_end_flow.xlsx" under sheet "group_documents" and row 21
    And user selects the document
    And user selects document status as "Pending"
