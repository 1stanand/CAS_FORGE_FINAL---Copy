...
Feature: Capturing_Group_Document_Home_Loan_Flow

  Scenario: ACAUTOCAS-15720: User should be able to disburse the home loan successfully with group document status updated
