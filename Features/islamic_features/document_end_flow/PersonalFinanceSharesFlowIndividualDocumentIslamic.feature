...
Feature: Capturing_Individual_Document_Personal_Finance_Shares_Flow_Islamic

Scenario: ACAUTOCAS-15965: User should be able to disburse the shares flow personal finance successfully with individual document status updated
...
#    And user saves Add view Bank details
    ...
    ##scan rescan of documents done
    And user reads data from the excel file "document_end_flow.xlsx" under sheet "individual_documents" and row 28
    And user selects document tab
    And user should be able to verify document status in next stage
      | document_end_flow.xlsx | individual_documents | 10 |
      | document_end_flow.xlsx | individual_documents | 11 |
