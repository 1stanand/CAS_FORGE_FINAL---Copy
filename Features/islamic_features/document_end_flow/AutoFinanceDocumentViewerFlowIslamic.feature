...
Feature: Document_Viewer_Auto_Finance_Flow

Scenario: ACAUTOCAS-15698: User should be able to disburse the auto finance successfully with document viewer features
