...
Feature: Capturing_Document_Through_Application_Update_Service_Personal_Finance_Metals_Flow

Scenario: ACAUTOCAS-15743: User should be able to disburse the personal finance metals flow successfully with changing the document status through application service
