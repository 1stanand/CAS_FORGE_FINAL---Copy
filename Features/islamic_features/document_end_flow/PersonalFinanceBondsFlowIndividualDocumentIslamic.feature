...
Feature: Capturing_Individual_Document_Personal_Finance_Bonds_Flow_Islamic

Scenario: ACAUTOCAS-15744: User should be able to disburse the bonds flow personal finance successfully with individual document status updated
...
#    And user verify the financial details
    ...
    And user reads data from the excel file "bank_credit_card_details.xlsx" under sheet "bank_details" and row 68
