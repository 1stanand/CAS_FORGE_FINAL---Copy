...
Feature: Capturing_Group_Document_Personal_Finance_Shares_Flow

  Scenario: ACAUTOCAS-15750: User should be able to disburse the personal finance shares successfully with group document status updated
