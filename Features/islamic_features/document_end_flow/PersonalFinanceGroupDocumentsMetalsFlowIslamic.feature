...
Feature: Capturing_Group_Document_Personal_Finance_Metals_Flow

  Scenario: ACAUTOCAS-15749: User should be able to disburse the personal finance metals successfully with group document status updated
