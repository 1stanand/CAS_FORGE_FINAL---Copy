...
Feature: Capturing_Document_Through_Application_Creation_Service_Personal_Finance_Shares_Flow

Scenario: ACAUTOCAS-15727: User should be able to disburse the personal finance shares flow successfully with document status updated through application service
