...
Feature: Capturing_Individual_Document_Home_Finance_Flow

Scenario: ACAUTOCAS-15721: User should be able to disburse the Home finance successfully with individual document status updated
