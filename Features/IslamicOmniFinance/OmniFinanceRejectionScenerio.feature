...
#    And user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from application grid
#    When user click on more action
#    And user click on Reject Application option
...
#    Then application of "<ProductType>" should be present at Rejected application grid
#    Examples:
#      | ApplicationStage   | ProductType   | ApplicantType   | Category | Key |
#      | <ApplicationStage> | <ProductType> | <ApplicantType> |          |     |
#
...
#  #${ProductType:["IOMNI"]}
#   #${ApplicationStage:["Post Approval"]}
#  #${action:["Sendback","Confirm Rejection"]}
#   #${ApplicantType:{"indiv"}]
...
#    And user click on Reject Application button
#    And user navigates at Rejected Application Grid
#    When user opens an application of "<ProductType>" product type as "<ApplicantType>" applicant at "<ApplicationStage>" for "<Category>" with "<Key>" from Rejected application grid
...
#    Then message "The application has been Reject confirmed" for the application of "<ProductType>" should be present
#    Examples:
#      | ApplicationStage   | ProductType   | ApplicantType   | Category | Key |
#      | <ApplicationStage> | <ProductType> | <ApplicantType> |          |     |
#
...
#    And user search application using application number
#    And user checks activity section
#    Then message "The application has been Reject confirmed" should be present for the application of <ProductType> product type
#    Examples:
